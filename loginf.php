    	...
    	<div class="card">
    		<div class="card-body">
    			<div class="row">
    				...
    				<h2> Login Failed - Activation Needed</h2>   

<?php

echo '<div class="error"><p>Please Activate Your acount. Please	Check Your Email for Verification Link</p><p><a href="index.php">Click here</a> to Go Back.</p></div><br />';
?>
