...
if(isset($_POST['submit']))
{
    ...
    $db->connect();
    $db->insert('appointment',array('doctorSpecialization'=>$specilization,'dusername'=>$dusername,'pusername'=>$pusername,'purpose'=>$purpose,'date'=>$date,'timeslot'=>$timeslot ,'symptoms'=>$symptoms,'vt'=>$vt )); // Table name, column names and values
                    ...
                    <div class="header-row">
                        ...
                        <nav class="primary-menu style-3 menu-spacing-margin">
                            ...
                            <ul class="menu-container">
                                ...
                                <li class="menu-item"><a  class="menu-link" href="Patient/patientdashboard.php"><div>Dashboard</div></a></li>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="feature-box fbox-plain">
                                ...
                                <div class="fbox-content">
                                    <h3>Lorem Ipsum</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent tincidunt arcu dui, ut tincidunt velit eleifend vel.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="oc-team" class="owl-carousel team-carousel carousel-widget" data-margin="30" data-nav="true" data-pagi="true" data-items-xs="1" data-items-sm="2" data-items-lg="3" data-items-xl="4">
                        ...
                        <div class="team">
                            <div class="team-image">
                                <img src="pms/images/doctors/1.jpg" alt="Dr. Test">
                            </div>
                            <div class="team-desc">
                                <div class="team-title"><h4>Dr. Test</h4><span>Cardiologist</span></div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <input type="hidden"  name="pusername" id="pusername" class="form-control" value="<?php echo htmlentities($patient->getUsername());?>"> </input>
                </div>

                <div class="form-group">
                    <input type="hidden"  name="first_name" id="first_name" class="form-control" value="<?php echo htmlentities($patient->getFirstName());?>"> </input>
                </div>

                <div class="form-group">
                    <input type="hidden"  name="last_name" id="last_name" class="form-control" value="<?php echo htmlentities($patient->getLastName());?>"> </input>
                </div>
...
<script>
 ...
 <script>
  function showAlert() {
    var myText = "Submitted Successfully";
    alert (myText);
  }
  </script>
 <script>
    ...
    $('#save_review').click(function(){
        ...
        else
        {
            $.ajax({
                ...
                method:"POST",
                data:{rating_data:rating_data, pusername:pusername, comment:comment , first_name:first_name , last_name:last_name },
                success:function(data)
                {
