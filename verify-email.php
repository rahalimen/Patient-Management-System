    	...
    	<div class="card">
    		<div class="card-body">
    			<div class="row">
    				...
    				<h2> Patient Account Activation</h2>   
...
"SELECT * FROM `patient` WHERE `email_verification_link`='".$token."' and `email`='".$email."';"
);
$d = date('Y-m-d H:i:s');
if (mysqli_num_rows($query) > 0) {
$row= mysqli_fetch_array($query);
if($row['email_verified_at'] == NULL){
mysqli_query($con,"UPDATE patient set email_verified_at ='" . $d . "' , status ='1' WHERE email='" . $email . "'");
echo '<div class="error"><p>Congratulations! Your email has been verified.</p><p><a href="index.php">Click here</a> to Login.</p></div><br />';
}else{
echo '<div class="error"><p>You have already verified your account with us.</p><p><a href="index.php">Click here</a> to Login.</p></div><br />';
}
} else {
echo '<div class="error"><p>This email has been not registered with us.</p><p><a href="index.php">Click here</a> to Sign-Up.</p></div><br />';
}
}
?>
